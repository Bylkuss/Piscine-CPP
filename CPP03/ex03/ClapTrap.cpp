...
/*   Updated: 2023/05/17 15:15:02 by loadjou          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::~ClapTrap()
{
    std::cout << YELLOW << "ClapTrap desroyed" << RESET << std::endl;
}
...
void ClapTrap::beRepaired(unsigned int amount)
{
    ...
    {
        this->_hitPoints += amount;
        std::cout << GREEN << this->_name << " repaired itself + " << amount << " hit points back!" << RESET <<std::endl;
        this->_energyPoints--;
    }
    else
    {
